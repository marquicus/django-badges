...
from badges.templatetags.badges_tags import badge_count, level_title, level_count
...
class BadgeTests(TestCase):
    ...
    def test_template_tags(self):
        ...
        self.assertEqual(badge_count(user), [{'count': 0, 'badge__level': '1'},
        ...
        self.assertEqual(badge_count(user), [{'count': 1, 'badge__level': '1'},
                                             {'count': 0, 'badge__level': '2'},
                                             {'count': 0, 'badge__level': '3'},
                                             {'count': 0, 'badge__level': '4'}])
